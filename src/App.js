...
function App() {
  return (
    <main className="flex flex-col p-8 m-4 bg-blue">
      <section>
        <div className="">
          <CardColor
            customBackground="p-8 rounded-lg shadow-lg bg-violet mb-8"
            photo={Daniel}
          ...
          />
          <CardColor
            customBackground="p-8 rounded-lg shadow-lg bg-gray mb-8"
            photo={Jonathan}
        ...
        <div>
          <CardWhite
            customBackground="p-8 mb-8 rounded-lg shadow-2xl bg-white"
            photo={Jeanette}
          ...
          <CardColor
            customBackground="p-8 rounded-lg shadow-lg bg-dark mb-8"
            photo={Patrick}
            name=" Patrick Abrams"
      ...
      <section>
        <CardWhite
          customBackground="p-8 rounded-lg shadow-2xl bg-white"
          photo={Kira}
          name="Kira Whittle"
